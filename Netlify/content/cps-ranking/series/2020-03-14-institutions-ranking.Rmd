---
title: "Chilean Institutions Ranking March 2020"
## weight:
date: '2020-03-14'
authors: ["bgonzalezbustamante"]
## categories: []
## tags: []
summary: 'Elaborated on March 14, 2020'
---
...
kable(Inst_Cum) %>%
  ## kable_styling() %>%
  footnote(general = "Compiled using data from the [CPS-Ranking](/cps-ranking/series/2020-03-05-impact-ranking/). Data collected on March 5, 2020.")
```
