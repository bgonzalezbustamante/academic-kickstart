...
kable(Inst_Cum) %>%
  ## kable_styling() %>%
  footnote(general = "Compiled using data from the [Impact Ranking](/~shil5311/ranking/series/2020-03-05-impact-ranking/). Data collected on 5 March 2020.")
```
...
González-Bustamante, B. (2020). *Chilean Political Science Impact Ranking Dataset* [Data collected on 5 March 2020]. DOI: [10.17605/OSF.IO/M3NZD](http://doi.org/10.17605/OSF.IO/M3NZD)
